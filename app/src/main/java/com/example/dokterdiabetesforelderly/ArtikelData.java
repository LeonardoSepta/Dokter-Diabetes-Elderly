...
public class ArtikelData {
    ...
    private static String[] detailDataArtikel = {
            "Puasa Ramadan merupakan ibadah wajib bagi umat Muslim yang mampu. Beruntung di Indonesia berpuasa, tidak makan dan minum selama 12 jam hingga 13 jam saja. Di bagian negara lain, ada umat Muslim yang harus berpuasa hingga 18 jam.",
    ...
    private static int[] imageDataArtikel = {
            R.drawable.perbanyak_protein_dan_serat,
